...
public:
    ...
    PLFunction(Params *params, vector<Insertion> insertions, int day, int client,bool st, bool backward);
    PLFunction(Params *params, vector<Insertion> insertions, int day, int client,bool st,int daily, bool backward);
